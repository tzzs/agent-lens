 ...
 * usage store is `~/.zcode/cli/db/db.sqlite`, and the capability surface is under
 * `~/.zcode/cli/plugins/`. Root resolution order is `ctx.dataRoot`, then
...
/** The one database every source in this adapter is a table of (§一). */
